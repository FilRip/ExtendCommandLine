...
namespace ExtendCommandLineLib
{
    ...
    {
        /// <summary>
        /// Retourne si oui ou non un argument est présent dans la ligne de commande du processus en cours<br/>
        ...
        /// <summary>
        /// Retourne si oui ou non un argument avec valeur est présent dans la ligne de commande du processus en cours<br/>
        ...
        /// <summary>
        /// Retourne la valeur d'un argument dans la ligne de commande du processus en cours<br/>
        /// Sans tenir compte de la casse et en supposant que le séparateur entre le nom de l'argument et sa valeur est le signe "=" (égal)
        /// </summary>
        /// <param name="argument">Argument à rechercher</param>
